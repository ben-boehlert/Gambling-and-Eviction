...
# sunab_pre_covid.R
#
# Sun-Abraham event study for states treated BEFORE September 2021
# Using monthly cohorts with shorter window: -6 to +18 months
################################################################################
...
cat("\n")
cat("================================================================================\n")
cat("SUN-ABRAHAM: PRE-COVID PERIOD (Monthly cohorts, -6 to +18 window)\n")
cat("================================================================================\n\n")
...
p <- ggplot(results, aes(x = event_time, y = coef)) +
  ...
  scale_shape_manual(values = c("TRUE" = 1, "FALSE" = 19),
                     ...
                     name = "") +
  labs(
    title = "Sun-Abraham Event Study: Pre-COVID Adopters",
...
ggsave("output/csdid_pretrends/pre_covid/sunab_pre_covid.pdf", p,
       width = 12, height = 7)
ggsave("output/csdid_pretrends/pre_covid/sunab_pre_covid.png", p,
       width = 12, height = 7, dpi = 300)

cat("  Saved plot\n\n")

# Save results
write.csv(results, "output/csdid_pretrends/pre_covid/sunab_results.csv", row.names = FALSE)

cat("Files saved:\n")
cat("  • output/csdid_pretrends/pre_covid/sunab_pre_covid.pdf\n")
cat("  • output/csdid_pretrends/pre_covid/sunab_pre_covid.png\n")
cat("  • output/csdid_pretrends/pre_covid/sunab_results.csv\n\n")

cat("================================================================================\n")
cat("SUMMARY\n")
cat("================================================================================\n\n")

cat("Sun-Abraham estimator for pre-COVID adopters:\n")
